...
function admin_icon(string $name): string
{
    $p = [
        ...
        'brush'   => 'M9.5 14.5 18 6l3 3-8.5 8.5c-1.2 1.2-3 1.4-4.2.4l-1.2-1c1-1.2 1.2-2.4 2.4-3.6zM5 19c-1 1-1 2-2 3 1.5 0 3-.5 4-1.5',
...
$nav = array_filter([
    ...
    ['media',     'Media',     'media', ''],
    ['menus',     'Menus',     'menu', ''],
    ['appearance', 'Appearance', 'brush', 'settings'],
